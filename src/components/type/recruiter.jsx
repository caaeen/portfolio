    ...
    <div className='w-full min-h-svh bg-primary'>
        ...
        <div className='relative w-full min-h-[75vh] overflow-hidden flex flex-col justify-end'>
            ...
            <div className='z-30 text-white  w-full max-h-[40vh] px-5 pb-5'>
                ...
                <p className='sm:w-[70%] sm:text-lp text-mb font-bold'>Lorem Lorem ipsum dolor sit, amet consectetur adipisicing elit. Necessitatibus itaque iusto corporis ex porro, fuga officiis corrupti expedita rem laboriosam, velit dolore quaerat ad cumque architecto nostrum delectus odio rerum? ipsum dolor sit, amet consectetur adipisicing elit. Corrupti ea obcaecati impedit tempora sunt eveniet vel enim quos assumenda voluptas sint, incidunt eum veritatis debitis quisquam fugit. In, omnis rem?</p>
            </div>
            <div className='z-30  w-full px-5 flex gap-5  pb-10'>
                <Link to="" className='hover:bg-gray-400/70 ease duration-200 bg-white text-primary border-white py-2 sm:px-5 px-3 sm:text-[17px] text-[15px] font-bold rounded'>
                    <i className="fa-solid fa-play mr-2"></i> Resume
                </Link>

                <a  target="blank" href='https://www.linkedin.com/in/christopher-canada-638492272?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app' className=' hover:bg-gray-400/50 ease duration-200 bg-[rgba(128,128,128,0.5)] text-white border-white py-2 sm:px-5 px-3 sm:text-[17px] text-[15px] font-bold rounded'>
