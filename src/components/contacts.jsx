      ...
      <div className='flex w-full h-full sm:flex-row flex-col  justify-center  pb-20'>
        ...
        <div className='relative sm:w-1/2  h-full md:pl-5 sm:pt-10 p-5 w-full text-white fades '>
          ...
          <div className='flex flex-wrap gap-5 py-5 sm:text-[35px] text-[30px]'>
            <a target='blank' href="https://github.com/caaeen"><i className="cursor-pointer z-20 hover:scale-115 active:scale-115 hover:text-accent ease duration-300 fa-brands fa-github"></i></a>
            <a target='blank' href="https://web.facebook.com/christopher.trinidad.948"><i className="cursor-pointer z-20 hover:scale-115 active:scale-115 hover:text-accent ease duration-300 fa-brands fa-facebook"></i></a>
            <a target='blank' href="https://www.messenger.com/e2ee/t/7827129624022882/"><i className="cursor-pointer z-20 hover:scale-115 active:scale-115 hover:text-accent ease duration-300 fa-brands fa-facebook-messenger"></i></a>
            <a target='blank' href="https://www.linkedin.com/in/christopher-canada-638492272/"><i className="cursor-pointer z-20 hover:scale-115 active:scale-115 hover:text-accent ease duration-300 fa-brands fa-linkedin"></i></a>
          </div><br />
