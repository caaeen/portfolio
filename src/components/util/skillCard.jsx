...
const SkillCard = ({logo, name, subtitle}) => {
  ...
  return (
    <div ref={skillCard} className='items-center relative hover:scale-105 active:scale-105 ease duration-300 fades cursor-pointer shadow-md rounded-[5px] grow-1 min-w-[140px] max-w-[180px] min-h-[150px] sm:text-comp text-mb p-2 pt-5 flex flex-col gap-4 bg-secondary pb-4'>
